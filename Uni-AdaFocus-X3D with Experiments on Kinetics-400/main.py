...
def train(args, train_loader, model, scaler, criterion, optimizer, epoch, log, tf_writer):
    ...
    for i, (input_glance, images_input, target) in enumerate(train_loader):
        ...
        with autocast(enabled=False):
            ...
            logit_1, global_logit_1, local_logit_1, temporal_logit_1, spatial_logit_1, action_1, action_3 = p1
            logit_2, global_logit_2, local_logit_2, temporal_logit_2, spatial_logit_2, action_2, ________ = p2
        ...
        if i % args.print_freq == 0:
            if not args.multiprocessing_distributed or (args.multiprocessing_distributed
                ...
                print(output)
                print(f'actions1 = {action_1[:2]}, actions2 = {action_2[:2]}, actions3 = {action_3[:2]}')
